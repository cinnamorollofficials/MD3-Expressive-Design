...
import { ACTIVITY, KPIS, ORDERS, REVENUE_BY_RANGE, SPARK, STOCK_ALERTS, TARGET_BY_RANGE, TOP_PRODUCTS, type Order, type OrderStatus } from './ShopDashboardPage.data';
import pageSource from './ShopDashboardPage.tsx?raw';
import dataSource from './ShopDashboardPage.data.ts?raw';
...
export function ShopDashboardPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      />
      <ExampleSourceSheet open={sourceOpen} onClose={() => setSourceOpen(false)} title="ACME Store" pageSource={pageSource} dataSource={dataSource} styleSource={styleSource} />
    </div>
  );
}
