...
const SEARCH_ITEMS: CommandItem[] = [
  ...
  { id: 'trading-ui', category: 'Examples', label: 'Trading UI (Pluang)', desc: 'Dark theme crypto and stock trading interface with candlestick charts', icon: 'candlestick_chart', hash: 'trading-ui' },
