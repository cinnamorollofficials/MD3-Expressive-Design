...
const COMPONENT_DOC_BLUEPRINTS: Record<string, Omit<ComponentMetadata, 'id' | 'label'>> = {
  ...
  'data-table': {
    ...
    props: [
      ...
      { name: 'variant', type: "'flat' | 'outlined' | 'striped' | 'flush'", default: "'flat'", description: 'Visual border and background style.' },
      { name: 'density', type: "'comfortable' | 'medium' | 'compact'", default: "'medium'", description: 'Row height padding density.' },
      ...
      { name: 'bulkActions', type: 'DataTableBulkAction[]', default: 'undefined', description: 'Floating actions toolbar when rows are selected.' },
      { name: 'searchable', type: 'boolean | SearchConfig', default: 'false', description: 'Top search toolbar and client-side filtering.' },
      { name: 'pagination', type: 'DataTablePaginationProps', default: 'undefined', description: 'Built-in pagination bar.' },
      { name: 'expandableRow', type: 'ExpandableRowProps<T>', default: 'undefined', description: 'Master-detail accordion rows.' },
      { name: 'treeMode', type: 'boolean', default: 'false', description: 'Hierarchical tree structure for nested rows.' },
      { name: 'onCellEdit', type: '(row: T, colId: string, val: any) => void', default: 'undefined', description: 'Callback when cell value is edited inline.' },
      { name: 'resizableColumns', type: 'boolean', default: 'false', description: 'Enable drag-to-resize column headers.' },
      COMMON_CLASS_PROP,
    ],
