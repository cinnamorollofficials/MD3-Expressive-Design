...
export function ButtonsPage({ activeComponent }: { activeComponent?: string }) {
  ...
  return (
    <>
      ...
      {(showAll || activeComponent === 'button') && (
        <>
          <DemoSection
...
<Button size="xl">XL</Button>`}
      ...
      {(showAll || activeComponent === 'icon-button') && (
        <DemoSection
          title="Icon Buttons"
...
<FAB icon="add" label="Compose" />`}
      ...
      {(showAll || activeComponent === 'fab-menu') && (
        <DemoSection
...
/>`}
      ...
      {(showAll || activeComponent === 'split-button') && (
        <DemoSection
...
/>`}
      ...
      {(showAll || activeComponent === 'segmented-button') && (
        <DemoSection
